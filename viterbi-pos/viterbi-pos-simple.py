...
test_words = testing_str.split()
last_word = test_words.pop()
last_word = last_word[:-1]
test_words.append(last_word)
test_words.append('.')
length_test_words = len(test_words)

test_words *= length_test_words
test_tags *= length_test_words
final_tags *= length_test_words

for i in range(length_test_words):
